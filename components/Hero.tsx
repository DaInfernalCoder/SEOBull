    ...
    <section className="w-full bg-gradient-to-r from-blue-100 to-purple-100">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-center gap-16 lg:gap-20 px-8 py-8 lg:py-20">
        <div className="flex flex-col gap-10 lg:gap-14 items-center justify-center text-center lg:text-left lg:items-start">
          <h1 className="font-extrabold text-4xl lg:text-6xl tracking-tight md:-mb-4 text-gray-800">
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            Houston based agency specializing in SEO services, to get more clicks and boost your website
            traffic without headaches. Proudly serving businesses all over Texas and worldwide.
            
          </p>
          <button className="btn btn-primary btn-wide" onClick={scrollToContact}>
            Get {config.appName}
          </button>
